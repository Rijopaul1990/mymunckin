...
<head>
    ...
    <title>My Munchkin- Customer Login</title>
    <!-- Favicon icon -->
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										<span class="text-black"><strong>User001</strong></span>
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a href="index.html" aria-expanded="false">
                     ...
                     <li><a href="messages.html" aria-expanded="false">
						<i class="fa fa-comments" aria-hidden="true"></i>

							<span class="nav-text">My Message</span>
						</a>
                    ...
                    <li><a href="javascript:void()" aria-expanded="false">
						<i class="fa fa-book" aria-hidden="true"></i>
							...
							<span class="nav-text">My Baby Book</span>
						</a>
                    ...
                    <li><a href="javascript:void()" aria-expanded="false">
						<i class="fa fa-globe" aria-hidden="true"></i>
							...
							<span class="nav-text">Update Webpage</span>
						</a>
                     ...
                     <li><a href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Digital Book</span>
						</a>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                               ...
                                               <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" placeholder="My Munchkin URL URL">
                                            </div>
                                            
                                            
                                             <div class="form-group col-md-6">
                                                <label>Current Plan</label>
                                                <input type="text" class="form-control" placeholder="Current Plan">
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="Expiary Date">
                                            </div>
