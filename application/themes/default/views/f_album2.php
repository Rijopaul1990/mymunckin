...
.ninteen .section .left-sec .edit_img:nth-child(1){
    height: 52%;
    margin-bottom: 10px;        
}

.ninteen .section .left-sec .edit_img:nth-child(2){
    height: 45%; 
}
            ...
            <div class="main-bg">
                ...
                <div class="top-sec">
                    <ul>
                        ...
                        <li>
                            <div class="edit_img" data-id="<?php echo @$all_mom_dads->id; ?>" data-img="<?php echo base_url(@$all_mom_dads->img); ?>"  >
                    ...
                    <div class="main-bg"> 
                        ...
                        <div class="top-sec">
                            <ul class="first">
                                ...
                                <li><div class="edit_img h-100" data-id="<?php echo @$all_laughs->id; ?>" data-img="<?php echo base_url(@$all_laughs->img); ?>" ><img src="<?php echo base_url(@$all_laughs->img); ?>"  class="edit"> </div> </li>
                                <?php } ?>
                            ...
                            <ul class="second">
                                 ...
                                 <?php if(@$laugh5){ ?>
                    <li><div class="edit_img h-100" data-id="<?php echo @$laugh5->id; ?>" data-img="<?php echo base_url(@$laugh5->img); ?>"  ><img src="<?php echo base_url(@$laugh5->img); ?>" class="edit" > </div></li>
                       <?php } ?>
                            </ul>
                        </div> 
                    </div>
                ...
                <div class="main-bg">
                    ...
                    <div class="top-sec">
                        <ul>
                             ...
                             <?php foreach($standing as $standings){ ?>
                                <li><div class="edit_img " data-id="<?php echo @$standings->id; ?>" data-img="<?php echo base_url(@$standings->img); ?>" ><img src="<?php echo base_url(@$standings->img); ?>"  class="edit"> </div> </li>
                                <?php } ?>
                ...
                <img src="<?php echo base_url('assets/'); ?>images2/r7-bg.png" class="bg-image"> 
                    <div class="top-sec">
                        <ul>
                            ...
                            foreach($all_standing as $all_standings){ 
                            ?>
                            ...
                            <li class="panda"><img src="<?php echo base_url('assets/'); ?>images2/shoes2.png" > </li>
                             <?php if($standing5){ ?>
                             <li><div class="edit_img"  data-id="<?php echo @$standing5->id; ?>" data-img="<?php echo base_url(@$standing5->img); ?>"><img src="<?php echo base_url(@$standing5->img); ?>" class="edit"> </div> </li>
                           <?php } ?>
                        </ul>
              ...
              <div class="seventeen">
                ...
                <div class="main-bg">
                    <div class="top-sec">
                        ...
                        <ul>
                             <?php if($foody1){ ?>
                             <li><div class="edit_img"  data-id="<?php echo @$foody1->id; ?>" data-img="<?php echo base_url(@$foody1->img); ?>"><img src="<?php echo base_url(@$foody1->img); ?>" class="edit"> </div> </li>
                           <?php } ?>
                            <li class="jar"><img src="<?php echo base_url('assets/'); ?>images2/jar.png"> </li>
                             <?php if($foody2){ ?>
                             <li><div class="edit_img"  data-id="<?php echo @$foody2->id; ?>" data-img="<?php echo base_url(@$foody2->img); ?>"><img src="<?php echo base_url(@$foody2->img); ?>" class="edit"> </div> </li>
                           <?php } ?>
                        </ul>
                    </div>
                </div>
               ...
               <div class="eighteen">
                    ...
                    <div class="main-bg"> 
                        ...
                        <div class="top-sec">
                            <ul class="second">
                                 <?php if($foody3){ ?>
                             <li><div class="edit_img"  data-id="<?php echo @$foody3->id; ?>" data-img="<?php echo base_url(@$foody3->img); ?>"><img src="<?php echo base_url(@$foody3->img); ?>" class="edit"> </div> </li>
                           <?php } ?>
                            </ul>
                            <ul class="first">
                            ...
                            foreach($all_foody as $all_foodys){ 
                            ?>
                            <li><div class="edit_img h-100"  data-id="<?php echo @$all_foodys->id; ?>" data-img="<?php echo base_url(@$all_foodys->img); ?>"><img src="<?php echo base_url(@$all_foodys->img); ?>" class="edit"> </div> </li>
               ...
               <div class="ninteen">
                    ...
                    <div class="main-bg">
                        ...
                        <div class="section">
                            ...
                            <div class="left-sec">
                                <?php foreach($birthday as $birthdays){ ?>
                                <li> <div class="edit_img " data-id="<?php echo @$birthdays->id; ?>" data-img="<?php echo base_url(@$birthdays->img); ?>"><img src="<?php echo base_url(@$birthdays->img); ?>"  class="edit"> </div> </li>
                               <?php } ?> 
                            </div> 
                        </div>  
                    </div>
                   ...
                   <div class="main-bg">
                        ...
                        <div class="top-sec">
                            <ul>
                                ...
                                <li> <div class="edit_img h-100" data-id="<?php echo @$all_birthdays->id; ?>" data-img="<?php echo base_url(@$all_birthdays->img); ?>"><img src="<?php echo base_url(@$all_birthdays->img); ?>"  class="edit"> </div> </li>
                               <?php } ?>
             ...
             <div class="twenty_one">
                ...
                <div class="main-bg"> 
                    ...
                    <div class="top-sec">
                        <ul class="second">
                            <?php if(@$sitting1){ ?>
                            <li><div class="edit_img h-100" data-id="<?php echo @$sitting1->id; ?>" data-img="<?php echo base_url(@$sitting1->img); ?>"><img src="<?php echo base_url(@$sitting1->img); ?>" class="edit"> </div> </li>
                            <?php } ?>
                            <div class="content">
                        ...
                        <ul class="first">
                            ...
                            <li><div class="edit_img h-100" data-id="<?php echo @$sitting2s->id; ?>" data-img="<?php echo base_url(@$sitting2s->img); ?>"><img src="<?php echo base_url(@$sitting2s->img); ?>" class="edit"> </div> </li>
                            <?php } ?>
             ...
             <div class="twenty_two">
                 ...
                 <div class="main-bg">
                    ...
                    <div class="top-sec">
                        <ul>
                            <?php if(@$sitting4){ ?>
                            <li><div class="edit_img h-100" data-id="<?php echo @$sitting4->id; ?>" data-img="<?php echo base_url(@$sitting4->img); ?>"><img src="<?php echo base_url(@$sitting4->img); ?>" class="edit"> </div> </li>
                            <?php } ?>
                       </li>
                            <?php if(@$sitting5){ ?>
                            <li><div class="edit_img h-100" data-id="<?php echo @$sitting5->id; ?>" data-img="<?php echo base_url(@$sitting5->img); ?>"><img src="<?php echo base_url(@$sitting5->img); ?>" class="edit"> </div> </li>
                            <?php } ?>     <img src="<?php echo base_url('assets/'); ?>images2/car.png" class="car">
                        </ul>
            ...
            <div class="main-bg">
                ...
                <div class="top-sec">
                    <ul>
                        ...
                        <li>
                            <div class="edit_img" data-id="<?php echo @$all_mom_dad->id; ?>" data-img="<?php echo base_url(@$all_mom_dad->img); ?>"  >
                    ...
                    <div class="main-bg"> 
                        ...
                        <div class="top-sec">
                            <ul class="first">
                                ...
                                <li><div class="edit_img h-100" data-id="<?php echo @$all_laugh->id; ?>" data-img="<?php echo base_url(@$all_laugh->img); ?>" ><img src="<?php echo base_url(@$all_laugh->img); ?>"  class="edit"> </div> </li>
                                <?php } ?>
                ...
                <div class="main-bg">
                    ...
                    <div class="top-sec">
                        <ul>
                             ...
                             <?php foreach($standing as $standing){ ?>
                                <li><div class="edit_img " data-id="<?php echo @$standing->id; ?>" data-img="<?php echo base_url(@$standing->img); ?>" ><img src="<?php echo base_url(@$standing->img); ?>"  class="edit"> </div> </li>
                                <?php } ?>
                ...
                <img src="<?php echo base_url('assets/'); ?>images2/r7-bg.png" class="bg-image"> 
                    <div class="top-sec">
                        <ul>
                            ...
                            foreach($all_standing as $all_standing){ 
                            ?>
                    ...
                    <div class="main-bg"> 
                        ...
                        <div class="top-sec">
                           ...
                           <?php } ?>
                            ...
                            foreach($all_foody as $all_foody){ 
                            ?>
                            <li><div class="edit_img h-100"  data-id="<?php echo @$all_foody->id; ?>" data-img="<?php echo base_url(@$all_foody->img); ?>"><img src="<?php echo base_url(@$all_foody->img); ?>" class="edit"> </div> </li>
                   ...
                   <div class="main-bg">
                        ...
                        <div class="top-sec">
                            <ul>
                                ...
                                <li> <div class="edit_img h-100" data-id="<?php echo @$all_birthday->id; ?>" data-img="<?php echo base_url(@$all_birthday->img); ?>"><img src="<?php echo base_url(@$all_birthday->img); ?>"  class="edit"> </div> </li>
                               <?php } ?>
                ...
                <div class="main-bg"> 
                    ...
                    <div class="top-sec">
                        ...
                        <ul class="first">
                            ...
                            <li><div class="edit_img h-100" data-id="<?php echo @$sitting2->id; ?>" data-img="<?php echo base_url(@$sitting2->img); ?>"><img src="<?php echo base_url(@$sitting2->img); ?>" class="edit"> </div> </li>
                            <?php } ?>
