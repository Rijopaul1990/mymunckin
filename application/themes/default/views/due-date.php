...
270deg
, <?php echo @$fetch_theme->theme ?>, <?php echo @$fetch_theme->theme ?>) !important;
}
.cong-temp-carousel {
    overflow: hidden;
    padding: 50px 0;
    background: radial-gradient(circle, rgb(249 249 249) 0%, <?php echo @$fetch_theme->theme ?> 45%) !important;
}
.aspect {
    margin-bottom: -40%;
}
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<a href="<?php echo base_url('templates'); ?>" class="btn btn-munchkin"><span>VIEW ALL</span></a>
			</div>
		</div>
	</div>
</section>
...
<?php } ?>
<?php 
//templete created and purchased any package
   // if($check_order >= 1){
?>
                ...
                ?>
		          <form id="date_enquiry" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        ...
                        <input type="hidden" name="type" value="<?php echo encrypt_url(2); ?>">
...
<div class="background-icons3">
	...
	<div class="container  album-newsection" >
		<div class="row">
                        ...
                        <?php          }
                             ...
                             if($i == 1){
                                if(count($fetch_flip_cate_image)%2 == 0){
                                     echo '<div class="page"><img src="'.base_url("assets/Milestones.png").'"  alt="" /></div>';
                                }
                            }else{
                                if(count($fetch_flip_cate_image)%2 == 0){
                                     echo '<div class="page"><img src="'.base_url("assets/Milestones.png").'"  alt="" /></div>';
