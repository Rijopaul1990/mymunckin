                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                <tr>
                                    ...
                                    <!--<img src="<?php echo base_url('assets/img/baby-img.png'); ?>" width="125" height="120" style="display: block; border: 0px;" />-->
                                        <h2 style="font-size: 30px; line-height: 36px; color: #FF721D; margin: 0;"> Thank You For Your Order! </h2>
                                    </td>
                                </tr>
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                <tr>
                                    <td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px;">
										...
										<p style="text-transform:uppercase;font-weight:700;margin: 0 0 10px;color: #fff;"> Order Confirmation</p>
										<p style="margin: 0 0 20px;color: #fff;"> Thank you for your order. For any queries, related to this order please contact us at <a href="mailto:support@mymunchkin.in">support@mymunchkin.in</a> .</p>
