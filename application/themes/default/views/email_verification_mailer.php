...
<html>
<head>
    <title>Mymunchkin - OTP Verification</title>
...
<body>
    ...
    box-sizing: border-box;">
                <h2 style="font-size: 28px;color: #5c5c5c;text-align: center;margin-top: 0;margin-bottom: 0px;position: relative !important;/* background-image: url('http://cyberworx.co.in/xtractivity/images/order-success-bg.png'); */">
                    <span style="color: #ff834f !important;">Registration</span> Successful
                </h2>
                <!--<img src="<?php echo base_url('assets/images/underline-head.PNG'); ?>" style="margin: 0 auto;margin-bottom: 20px;">-->
            </div>
            <div class="emailer-content" style="padding: 30px;text-align: center;font-size: 17px;">
                ...
                <p>You have successfully registered with <span style="color: #dd2533;">Us</span></p>
                <p>Please click the following link to Verify Email:</p>
                <a
                    href="<?php echo $link; ?>"
                    class="hyundai-btn"
                    style="
                        background: #FF721D;color: #fff;border-radius: 50px;padding: 15px 20px;min-width: 180px;font-weight: 500;font-size: 14px;transition: 0.3s all;position: relative;z-index: 99999;overflow: hidden;
                    "
                >
                    Click here
                </a>
