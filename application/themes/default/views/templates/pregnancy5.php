...
<link href="https://fonts.googleapis.com/css2?family=Nunito:wght@200;300;400;600&display=swap" rel="stylesheet">
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/canvas.css'); ?>">  
    ...
    <link rel="stylesheet" href="http://cyberworx.co.in/gif/loader/loader.min.css">
    <script src="http://cyberworx.co.in/gif/loader/loader.min.js"></script>
...
.loading div#backdrop {
    ...
    <div id="backdrop"></div>
        ...
        <img id="frame-holder" src="<?php echo base_url('assets/images/preg_001.png'); ?>" data-path="<?php echo base_url('assets/zoo_frame/zoo'); ?>" data-frames="28" class="bg-image" crossorigin="anonymous">  
            <div id="content">
                <div class="top-sec">
                    <div class="left-top">
                        <h3> Coming Soon    </h3>
