...
.main-bg{
    /*max-width: 500px;*/
    /*margin: 0 auto;*/
    /*background: url(<?php echo base_url('assets/'); ?>images/Bday1.svg);*/
...
<body width="100%" style="margin: 0; padding: 0 !important; background-color: #222222;">
    <div class="main-bg">
    <img src="<?php echo base_url('assets/'); ?>images/Bday1.svg" class="bg-image">   

        <div class="top-sec">
            <div class="left-top">
                <h4>YOU ARE INVITED </h4>
                <h3> Angenila  <span>is turning</span>  </h3>
                <div class="cake-year">
                    <img src="<?php echo base_url('assets/'); ?>images/cake.svg" />
                    <span>1</span>
                </div>
        ...
        <div class="bottom-sec">
            ...
            <div class="title2-bot">
                <p>SATURDAY 20 APRIL </p>
                <p class="add">VIKAS MARG, VASANT KUNJ NEW DELHI</p>
            </div>
