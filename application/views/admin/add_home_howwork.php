  ...
  <section class="content">
    ...
    <div class="panel panel-success">
      <div class="panel panel-heading">
        ...
        <span class="pull-right"><a href="<?php echo base_url('admin/all_home_howwork') ?>" class="btn btn-xs btn-munchkin"><i class="fa fa-reply" aria-hidden="true"></i>
        Back</a></span>
      </div>
          ...
          <div class="col-sm-6">
           ...
           <div class="col-sm-6">
              <div class="form-group">
                ...
                <?php echo form_input(array('class' => "form-control",'name' =>"you_tube_link","placeholder"=>" YouTube Link","value" =>set_value('you_tube_link',@$you_tube_link))); ?>
              </div>
              <span><?php echo form_error('you_tube_link'); ?></span>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
